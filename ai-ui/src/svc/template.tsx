...
async function template(props: ITemplateProps) {
  const temp = '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,shrink-to-fit=no"><meta name="theme-color" content="#000000"><link rel="stylesheet" href="https://static2.sharepointonline.com/files/fabric/office-ui-fabric-core/9.5.0/css/fabric.min.css"><link rel="manifest" href="client/manifest.json"><link rel="shortcut icon" href="client/favicon.ico"><title>%title%</title><link href="%mainCss%" rel="stylesheet"></head><body><noscript>You need to enable JavaScript to run this app.</noscript><style rel="stylesheet" type="text/css">%styles%</style><div id="root">%body%</div><script type="text/javascript">window.__APP_INITIAL_STATE__ = %initialState%;</script><script type="text/javascript" src="%mainJs%"></script></body></html>';
